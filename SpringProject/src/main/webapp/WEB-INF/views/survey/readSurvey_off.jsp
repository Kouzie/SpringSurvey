            ...
            <div class="tm-bg-primary-dark tm-block tm-block-settings">
              <form action="" class="tm-signup-form row">
                ...
                <div class="form-group col-lg-3">
                  <button type="submit" class="btn btn-primary text-uppercase btn-show">삭제</button>
                  <button type="submit" class="btn btn-primary text-uppercase btn-show">마감</button>
                </div>
                <div class="form-group col-lg-3 show-right">
                  <button type="submit" class="btn btn-primary text-uppercase btn-show">투표하기</button>
                  <button type="submit" class="btn btn-primary text-uppercase btn-show">나가기</button>
                </div>
